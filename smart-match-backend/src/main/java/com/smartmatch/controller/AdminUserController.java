...
public class AdminUserController {
    ...
    @PostMapping("/{id}/run-cv-analysis")
    public ResponseEntity<AdminUserDetailResponse> runCvAnalysis(@PathVariable String id) {
        return ResponseEntity.ok(adminUserDetailService.runCvAnalysis(id));
    }
}

...
public class ChatController {
    ...
    public ResponseEntity<List<MessageResponse>> getMessages(@PathVariable String id) {
        return ResponseEntity.ok(chatService.getMessages(SecurityUtils.currentUser().getId(), id));
    }
    ...
    public void handleStomp(@Payload SendMessageRequest request, Principal principal) {
        MessageResponse response = chatService.sendMessage(
